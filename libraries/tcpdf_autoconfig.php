...
if (!defined('PDF_HEADER_LOGO_ESCUDO')) {
    $tcpdf_header_logo = '';
    if (@file_exists(K_PATH_IMAGES . 'escudocolombia.jpg')) {
        $tcpdf_header_logo = 'escudocolombia.jpg';
    }
    define('PDF_HEADER_LOGO_ESCUDO', $tcpdf_header_logo);
}
